def characteristic():  # читает файл с характеристиками, возвращает словарь с характеристиками
...
def create_player_ship():  # читает файл с настроками игрока, возвращает список настроек
    with open('settings\current_player_settings.txt', 'r', encoding='utf-8') as setting:
        return [i.strip() for i in setting.readlines()]
    

def enemy_placement(filename):  # читает файл с расположением врагов, возвращает матрицу расположения врагов
